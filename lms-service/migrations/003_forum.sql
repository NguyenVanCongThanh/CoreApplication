...
-- ============================================================
-- TRIGGER: keep comment_count on forum_posts in sync
-- ============================================================
...
-- ============================================================
-- TRIGGER: keep upvotes / downvotes denormalized counters in sync
-- ============================================================

CREATE OR REPLACE FUNCTION update_vote_counts()
RETURNS TRIGGER AS $$
BEGIN
    -- Helper: apply delta (+1 or -1) to the right table / column
    -- Uses dynamic SQL to avoid four-way duplication
    IF TG_OP = 'INSERT' THEN
    ...
    ELSIF TG_OP = 'UPDATE' AND OLD.vote_type <> NEW.vote_type THEN
        -- Vote flipped: reverse the old, apply the new
        IF NEW.votable_type = 'post' THEN
            IF NEW.vote_type = 'upvote' THEN
