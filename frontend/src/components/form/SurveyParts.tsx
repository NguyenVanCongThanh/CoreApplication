...
export const SurveySuccess = ({ 
  ...
  <div className="min-h-[70vh] flex items-center justify-center p-4">
    <div className="max-w-xl w-full bg-white rounded-3xl border border-slate-200 shadow-sm p-10 text-center">
      ...
      <div className="bg-blue-50/50 rounded-xl p-6 text-left border border-blue-100 mb-8">
        <p className="font-semibold text-slate-900 mb-2">📊 Thông tin sẽ được sử dụng để:</p>
